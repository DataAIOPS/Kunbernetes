...
<h4>Also verify if minikube is installed and it should be started using below command</h4>
...
docker tag model_image dataaiopshub/model_image
docker push dataaiopshub/model_image
